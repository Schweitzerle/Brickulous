...
public class GetSetByNumberPlaneData extends AsyncTask<String, String, String> {

    Context context;
    String urlString;
    List<LegoSetData> legoSetData;

    public GetSetByNumberPlaneData(Context context, String urlString, List<LegoSetData> legoSetData) {
        this.context = context;
        this.urlString = urlString;
        this.legoSetData = legoSetData;
    }

    public GetSetByNumberPlaneData(Context context, String urlString) {
        this.context = context;
        this.urlString = urlString;
    }
    ...
    public List<LegoSetData> getLegoSetData() {
        return legoSetData;
    }
}
